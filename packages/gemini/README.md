...
Google Gemini adapter for [Losi Context Bank](https://github.com/losi-ai/context-bank). Give Gemini persistent business context, then switch models without losing it.
